...
extern Value getVariable(Variable **variables, const char *const name);

extern void list_init(List **lists, List *list, const char *const name);
extern List* list_create(List **lists, const char *const name);
extern void freeLists(List **lists);
extern List* getListPtr(List **lists, const char *const name);
